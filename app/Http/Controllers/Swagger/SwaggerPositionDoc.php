 ...
 * @OA\Post(
 *     path="/api/position/",
 *     summary="post position\создание position ",
 *     tags={"Position"},
 *     @OA\RequestBody(
 *          @OA\JsonContent(
 *              allOf={
 ...
 *     summary="get position\ получение одной записи уровня образования ",
 *     tags={"Position"},
 *      @OA\Parameter(
 ...
 * @OA\Patch(
 *     path="/api/position/{position}",
 *     summary="patch position\ обновление ",
 *     tags={"Position"},
 *      @OA\Parameter(
 *         description="position ID \ id уровня",
 *         in="path",
...
class SwaggerPositionDoc extends Controller
{
    //
}
